import { Search, Filter, Plus, Snowflake } from "lucide-react";
...
export function InventoryPage() {
  const inventory = [
    ...
    { 
      sku: 'SKU-5692', 
      description: 'Pharmaceutical Vaccine Batch A', 
    ...
    { 
      sku: 'SKU-9876', 
      description: 'Food Items - Frozen Meals', 
    ...
    { 
      sku: 'SKU-7654', 
      description: 'Medical Equipment - X-Ray Film', 
      client: 'HealthCare Supplies', 
      warehouse: 'WH-Delhi-01',
      onHand: 200,
      reserved: 80,
      available: 120,
